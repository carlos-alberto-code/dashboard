...
import {getLearningData} from "../api/aprendizaje.ts";
    ...
    return (
        <div className="bg-white border border-gray-300 rounded-xl py-5 px-5 shadow flex flex-col gap-3">
            ...
            <div className="flex items-baseline gap-2">
                <span
                    className={`text-3xl font-bold ${isBelowTarget ? 'text-red-500' : 'text-uvm-negro'}`}>{value}</span>
